...
with open("/Users/Kunal/workspaceThesis/LINDA/Data/imdb1.nt") as f:
    for line in f:
        data = line.split("\t")
...
with open('/Users/Kunal/workspaceThesis/LINDA/Data/imdb1/operator2Id.csv', 'w') as mapfile:
    for  operator, id in operator2Id.iteritems():
        mapfile.write( operator +"," +str(id)+"\n")
mapfile.close

for operator, id in operator2Id.iteritems():
    with open("/Users/Kunal/workspaceThesis/LINDA/Data/imdb1/LIBSVM/" + str(operator2Id[operator]) +".libsvm", "a") as libfile:
